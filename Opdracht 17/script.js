...
console.log(typeof showMessage2)//ƒ showMessage2(color)
console.dir(showMessage2)//undefined
...
//swich the order of arguments :

const paint = function (color2, color1) {
    console.log('The north wall has been painted', color1, 'and the south wall has been painted', color2)
};
